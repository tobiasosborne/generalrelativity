...
symmetrisation).  We then turn to the central geometric question
of general relativity: \emph{what is curvature?}
...
\noindent
In general relativity, spacetime is \textbf{not} embedded in any
ambient space---we need a purely intrinsic notion of curvature.
