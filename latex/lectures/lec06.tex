...
the tangent space at~$p$.  Our goal in this lecture is to study
how vectors $v\in V_p$, covectors $\omega\in V_p^*$, and more
general tensors transform under a change of coordinates on~$\M$.
...
We now illustrate the tensor concept with three physically
important examples, all set in Minkowski
spacetime~$\M = \Rn{1,3}$.
...
\begin{remark}
  ...
  convenience of the index calculus.
\end{remark}
